...
class CommonLoginApi
{
   ...
   /**
     ...
     */
    public function endSessionAsync($userID)
    {
        return $this->endSessionAsyncWithHttpInfo($userID)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function endSessionAsyncWithHttpInfo($userID)
    {
        $returnType = '\com\edel\edelconnect\models\LogOutDao';
        $request = $this->endSessionRequest($userID);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function loginDataAsync($sourceToken, $appIdKey, $body = null)
    {
        return $this->loginDataAsyncWithHttpInfo($sourceToken, $appIdKey, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function loginDataAsyncWithHttpInfo($sourceToken, $appIdKey, $body = null)
    {
        $returnType = '\com\edel\edelconnect\models\LoginAuthDataResponse';
        $request = $this->loginDataRequest($sourceToken, $appIdKey, $body);
    ...
    /**
     * Operation validateVendorCrdntialsAsync
     *
     * To validate vendor id and password &amp; generate session
     *
     * This oepration contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function validateVendorCrdntialsAsync($vendorID, $source, $body)
    {
        return $this->validateVendorCrdntialsAsyncWithHttpInfo($vendorID, $source, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation validateVendorCrdntialsAsyncWithHttpInfo
     *
     * To validate vendor id and password &amp; generate session
     *
     * This oepration contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function validateVendorCrdntialsAsyncWithHttpInfo($vendorID, $source, $body)
    {
        $returnType = '\com\edel\edelconnect\models\GnrResDao';
        $request = $this->validateVendorCrdntialsRequest($vendorID, $source, $body);

...
class CommodityTradeBookApi
{
   ...
   /**
     ...
     */
    public function getTradesAsync($userID, $nOID = null)
    {
        return $this->getTradesAsyncWithHttpInfo($userID, $nOID)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTradesAsyncWithHttpInfo($userID, $nOID = null)
    {
        $returnType = '\com\edel\edelconnect\models\ComTradeBookDao';
        $request = $this->getTradesRequest($userID, $nOID);

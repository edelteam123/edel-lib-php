...
class MFTradeApi
{
   ...
   /**
     ...
     */
    public function modifyTradeMFAsync($userId, $body = null)
    {
        return $this->modifyTradeMFAsyncWithHttpInfo($userId, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation modifyTradeMFAsyncWithHttpInfo
     *
     * Modify/Cancel order Method
     *
     * This oepration contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function modifyTradeMFAsyncWithHttpInfo($userId, $body = null)
    {
        $returnType = '\com\edel\edelconnect\models\TradeMFResponseDao';
        $request = $this->modifyTradeMFRequest($userId, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function placeTradeMFAsync($userId, $body = null)
    {
        return $this->placeTradeMFAsyncWithHttpInfo($userId, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation placeTradeMFAsyncWithHttpInfo
     *
     * Place trade Method
     *
     * This oepration contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function placeTradeMFAsyncWithHttpInfo($userId, $body = null)
    {
        $returnType = '\com\edel\edelconnect\models\TradeMFResponseDao';
        $request = $this->placeTradeMFRequest($userId, $body);

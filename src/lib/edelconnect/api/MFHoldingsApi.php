...
class MFHoldingsApi
{
   ...
   /**
     ...
     */
    public function getAllHoldingsAsync($userId)
    {
        return $this->getAllHoldingsAsyncWithHttpInfo($userId)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAllHoldingsAsyncWithHttpInfo
     *
     * Retrieving All of clients holdings
     *
     * This oepration contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllHoldingsAsyncWithHttpInfo($userId)
    {
        $returnType = '\com\edel\edelconnect\models\MFHoldingsResponseDao';
        $request = $this->getAllHoldingsRequest($userId);

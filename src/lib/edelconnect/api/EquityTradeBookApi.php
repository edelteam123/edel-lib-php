...
class EquityTradeBookApi
{
     ...
     */
    public function getTradeBookAsync($userID, $nOID = null)
    {
        return $this->getTradeBookAsyncWithHttpInfo($userID, $nOID)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getTradeBookAsyncWithHttpInfo
     *
     * Shows trade book for a client in equity
     *
     * @param  string $userID UserId of the client (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTradeBookAsyncWithHttpInfo($userID, $nOID = null)
    {
        $returnType = '\com\edel\edelconnect\models\EqTradeBookDao';
        $request = $this->getTradeBookRequest($userID, $nOID);

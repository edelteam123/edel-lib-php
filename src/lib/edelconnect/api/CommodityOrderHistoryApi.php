...
class CommodityOrderHistoryApi
{
   ...
   /**
     ...
     */
    public function getOrderHistoryAsync($userID, $sDt = null, $eDt = null)
    {
        return $this->getOrderHistoryAsyncWithHttpInfo($userID, $sDt, $eDt)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrderHistoryAsyncWithHttpInfo($userID, $sDt = null, $eDt = null)
    {
        $returnType = '\com\edel\edelconnect\models\ComOrderHistoryDao';
        $request = $this->getOrderHistoryRequest($userID, $sDt, $eDt);
